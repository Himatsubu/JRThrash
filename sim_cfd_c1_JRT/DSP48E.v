...
// CR 619940 -- Enhanced DRC warning
	      ...
	      $display("DRC warning note : The simulation model does not know the placement of the DSP48E slices used, so it cannot fully confirm the above warning. It is necessary to view the placement of the DSP48E slices and ensure that these warnings are not being breached\n"); 
            end  
        end  
    end 
