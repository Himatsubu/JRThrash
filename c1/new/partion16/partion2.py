...
for i in xrange(65,97):
    print "	u["+str(i*129)+"+k]=sub06.result["+str(i*129)+"+k];"
for i in xrange(97,129):
    print "	u["+str(i*129)+"+k]=sub07.result["+str(i*129)+"+k];"

for i in xrange(2,33):
    print "	u["+str(i*129)+"+k+32]=sub08.result["+str(i*129)+"+k+32];"
for i in xrange(33,65):
    print "	u["+str(i*129)+"+k+32]=sub09.result["+str(i*129)+"+k+32];"
for i in xrange(65,97):
    print "	u["+str(i*129)+"+k+32]=sub10.result["+str(i*129)+"+k+32];"
for i in xrange(97,129):
    print "	u["+str(i*129)+"+k+32]=sub11.result["+str(i*129)+"+k+32];"

for i in xrange(2,33):
    print "	u["+str(i*129)+"+k+64]=sub12.result["+str(i*129)+"+k+64];"
for i in xrange(33,65):
    print "	u["+str(i*129)+"+k+64]=sub13.result["+str(i*129)+"+k+64];"
for i in xrange(65,97):
    print "	u["+str(i*129)+"+k+64]=sub14.result["+str(i*129)+"+k+64];"
for i in xrange(97,129):
    print "	u["+str(i*129)+"+k+64]=sub15.result["+str(i*129)+"+k+64];"
print "}"
