...
for i in xrange(32,66):
    print "	sub09.u["+str((i-31)*129)+"+k+32]=u["+str(129*i)+"+k+32];"
for i in xrange(64,98):
    print "	sub10.u["+str((i-63)*129)+"+k+32]=u["+str(129*i)+"+k+32];"
for i in xrange(96,130):
    print "	sub11.u["+str((i-95)*129)+"+k+32]=u["+str(129*i)+"+k+32];"

for i in xrange(1,34):
    print "	sub12.u["+str(i*129)+"+k+64]=u["+str(129*i)+"+k+64];"
for i in xrange(32,66):
    print "	sub13.u["+str((i-31)*129)+"+k+64]=u["+str(129*i)+"+k+64];"
for i in xrange(64,98):
    print "	sub14.u["+str((i-63)*129)+"+k+64]=u["+str(129*i)+"+k+64];"
for i in xrange(96,130):
    print "	sub15.u["+str((i-95)*129)+"+k+64]=u["+str(129*i)+"+k+64];"
print "}"
